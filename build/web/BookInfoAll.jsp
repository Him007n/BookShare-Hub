...
PreparedStatement st = con.prepareStatement("select * from booktable");
...
<table border="10px" width="1600px;" align="center" style="background-color: whitesmoke; font-size: 30px; margin-top: 50px; ">
    ...
    <%
        ...
        <h1 style="color: darkgray; margin-top: 90px; margin-left: 30px;">DELETE BOOK INFORMATION</h1>
    <form action="BookInfoDelCode.jsp">
        <p style=" font-size: 22px; color: white; margin-left: 30px;">Book Id :
